...
- **Implemented public subcommands** ``init`` → :mod:`argos.cli.commands.init`,
  ...
  :mod:`argos.cli.commands.status`, ``attend`` →
  :mod:`argos.cli.commands.attend`, and ``sync`` →
  :mod:`argos.cli.commands.sync`. All public subcommands are implemented.
