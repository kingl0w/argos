...
Steps:
1. Find next ADR number from .specs/decisions/ADR-*.md.
2. Create .specs/decisions/ADR-NNN-<kebab-slug>.md with sections: Context, Options (A/B/C with Pros/Cons/Cost), Recommendation, Decision (blank, for user), Consequences (blank).
3. Update blocked ticket's verification section to reference this ADR.
4. Add entry to .specs/STATE.md under ## Open decisions.
