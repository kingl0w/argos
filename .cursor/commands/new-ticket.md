...
2. Create .specs/tickets/<PREFIX>-NNN-<kebab-slug>.md with sections: title header, **Status:** Queued, **Created:** <date>, **Priority:** (ask user P0/P1/P2), Intent, Context, Non-goals, Acceptance criteria (draft, rough — planner will refine).
